...
const RadioSm: React.FC<RadioProps> = ({
  ...
  return (
    <label
      htmlFor={id}
      className={`flex flex-wrap cursor-pointer select-none items-center text-sm text-gray-500 dark:text-gray-400 ${className}`}
    >
      <span className="relative">
        ...
        {/* Styled Radio Circle */}
        <span
          className={`mr-2 flex flex-wrap h-4 w-4 items-center justify-center rounded-full border ${
            checked
